...
hello_model_path = "tensorflow/lite/micro/examples/hello_world/hello_world.tflite"


class InputTest(test.TestCase):
  "Run with each supported type of model input."

  tflite_path = "tensorflow/lite/micro/examples/hello_world/hello_world.tflite"

  def test_tflite_path(self):
    is_match = crosscheck.versus_lite(tflite_path=hello_model_path)
